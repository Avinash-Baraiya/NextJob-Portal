...
export const register = catchAsyncErrors(async (req, res, next) => {
  try {
    ...
    if (
      ...
      return next(
        new ErrorHandler("Please provide your preferred job preferences.", 400)
      );
    }
...
export const updateProfile = catchAsyncErrors(async (req, res, next) => {
  ...
  const { preference1, preference2, preference3 } = newUserData.jobPreferences;
  ...
  if (
    ...
    return next(
      new ErrorHandler("Please provide all your preferred job preferences.", 400)
    );
  }
  if (req.files) {
