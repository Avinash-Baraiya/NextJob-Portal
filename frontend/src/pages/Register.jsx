...
const Register = () => {
  ...
  // CHANGED: use preference1, preference2, preference3
  ...
  const handleRegsiter = (e) => {
    ...
    if (role === "Job Seeker") {
      // CHANGED: use preference1, preference2, preference3
      formData.append("preference1", preference1);
      formData.append("preference2", preference2);
      formData.append("preference3", preference3);
          ...
          <form onSubmit={handleRegsiter}>
            ...
            {role === "Job Seeker" && (
              <>
                <div className="wrapper">
                  <div className="inputTag">
                    <label>Your First Job Preference</label>
                    <div>
                      <select
                        value={preference1}
                  ...
                  <div className="inputTag">
                    <label>Your Second Job Preference</label>
                    <div>
                      <select
                        value={preference2}
                  ...
                  <div className="inputTag">
                    <label>Your Third Job Preference</label>
                    <div>
                      <select
                        value={preference3}
